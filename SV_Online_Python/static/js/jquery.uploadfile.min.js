...
!
function(e) {
    void 0 == e.fn.ajaxForm && e.getScript("jquery.form.js");
    var a = {};
    ...
    e.fn.uploadFile = function(t) {
        ...
        function i(a) {
            ...
            var r, o, s = t.length,
            i = [];
            for (r = 0; s > r; r++) t[r] = t[r].replace(/\+/g, " "),
            o = t[r].split("="),
        ...
        function h(t, r, o, s) {
            ...
            u.change(function() {
                ...
                if (c(o, t), s.unbind("click"), d.hide(), h(t, r, o, s), d.addClass(r), o.serialize && a.fileapi && a.formdata) {
                    ...
                    for (var w = "",
                    g = 0; g < i.length; g++) w += o.showFileCounter ? t.fileCounter + o.fileCounterStyle + i[g] + "<br>": i[g] + "<br>",
                    t.fileCounter++;
